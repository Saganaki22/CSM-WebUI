...
with gr.Blocks(title="CSM-WebUI") as app:
    ...
    <div style="text-align: center; margin: 20px 0;">
        <a href="https://github.com/Saganaki22/CSM-WebUI" style="text-decoration: none; color: inherit;">
            <h1 style="font-size: 2.3rem; font-weight: bold; margin: 0;">CSM-WebUI (Windows)</h1>
        </a>
    </div>
    """)
    ...
    This is the Windows-compatible version using triton-windows.
    ...
    **Windows Note:** This version uses the triton-windows package instead of triton.
    ...
    - **Windows Note**: This version uses triton-windows package instead of triton.
