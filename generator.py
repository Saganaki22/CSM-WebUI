...
try:
    ...
    # If direct import fails, try with the module path
    print("Direct import of MimiModel failed. Using loaders instead.")
    # We'll use loaders.get_mimi() instead of direct MimiModel import
...
def load_local_mimi(device, local_path=None):
    ...
    try:
        ...
        # This is more reliable and works with different moshi versions
